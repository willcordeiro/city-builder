...
export function RainSystem({ intensity = 0 }) {
  ...
  useEffect(() => {
    ...
    rainGeometry.current.setAttribute('position', new THREE.BufferAttribute(positions, 3))
    rainGeometry.current.setAttribute('size', new THREE.BufferAttribute(sizes, 1))
